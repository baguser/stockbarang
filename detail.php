                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <?php 
                            ...
                            $ambildakeluar = mysqli_query($conn, "select * from keluar where idbarang='$idbarang'");
                            $i =1;
                            while($fetch=mysqli_fetch_array($ambildakeluar)){
                            $tanggal = $fetch['tanggal'];
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <br>
        <input type="number" name="stock" placeholder="stock" class="form-control" value="0" min="0" required>
        <br>
        <input type="file" name="file" class="form-control" required>
        <br>
        <button type="submit" class="btn btn-primary" name="addnewbarang">button</button>
        </div>
        </form>
